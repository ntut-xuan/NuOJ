...
all:
	...
	sudo mysql --user="root" --database="NuOJ" --execute="CREATE TABLE \`problem\` (\`ID\` int NOT NULL AUTO_INCREMENT, \`name\` VARCHAR(20) NOT NULL, \`visibility\` VARCHAR(20) NOT NULL, \`author\` VARCHAR(20) NOT NULL, PRIMARY KEY(ID)));"
