...
# def progressPage():
#     asana_util = asana.AsanatUil(
#         json.loads(open("/etc/nuoj/setting.json", "r").read())["asana"]["token"]
#     )
#     fetch_section_id = [
#         "1202538198680473",
#         "1202538198680519",
...
#             completed_time = parser.parse(task["completed_at"]).astimezone(
#                 pytz.timezone("Asia/Taipei")
#             )
#             completed_time_string = datetime.strftime(
#                 completed_time, "%Y-%m-%d %H:%M:%S"
#             )
#             assignee_photo = None
...
#                 {
#                     "task_section_name": task_section_name,
#                     "task_name": task["name"],
#                     "task_complete_time": completed_time_string,
#                     "task_assignee": task["assignee"]["name"],
#                     "task_assignee_photo": assignee_photo,
#                     "task_color": card_background_color,
#                 }
#             )
#             complete_task_count_by_section[task_section_gid] += 1
#         section_complete_percentage[task_section_gid] = (
#             complete_task_count_by_section[task_section_gid]
#             / task_count_by_section[task_section_gid]
#         )

#     completed_task_info = sorted(
#         completed_task_info, key=lambda d: d["task_complete_time"], reverse=True
#     )
...
#     web_app_heartbeat_info = [
#         data_proc(data) for data in setting_util.web_app_heartbeat_check()
#     ]
#     database_heartbeat_info = [
#         data_proc(data) for data in setting_util.database_heartbeat_check()
#     ]
#     judge_server_heartbeat_info = [
#         data_proc(data) for data in setting_util.judge_server_heartbeat_check()
#     ]
