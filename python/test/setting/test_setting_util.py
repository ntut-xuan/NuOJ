...
def test_setting_builder_from_dict_should_return_valid_setting_object(setting_dict: dict[str, Any]):
...
def test_edit_setting_with_assign_value_should_replace_the_setting_value(setting_dict: dict[str, Any]):
    setting: Setting = SettingBuilder().from_dict(setting_dict)
